            ...
            <div class="card-body card-block">
                <form action="{{route('update-category')}}" method="post" class="form-horizontal">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" name="add_category" class="form-control" value="{{$category->add_category}}"></div>
                        <div class="col-12 col-md-9"><input type="hidden" name="id" class="form-control" value="{{$category->id}}"></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label class=" form-control-label">Category Description</label></div>
                        <div class="col-12 col-md-9"><input type="text" name="category_description" class="form-control" value="{{$category->category_description}}"></div>
                    </div>
