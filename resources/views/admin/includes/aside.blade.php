            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-puzzle-piece"></i><a href="{{route('add-category')}}">Add Category</a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="{{route('add-brand')}}">Add Brand</a></li>
                        <li><i class="fa fa-table"></i><a href="tables-data.html">Manage Brand</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-th"></i><a href="{{route('add-product')}}">Add Product</a></li>
                        <li><i class="menu-icon fa fa-th"></i><a href="{{route('manage-product')}}">Manage Product</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
                    <a href="{{route('manage-orders')}}"><i class="menu-icon fa fa-adn"></i>Manage Orders</a>
                </li>
